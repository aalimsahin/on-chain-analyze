...
const getTrial = async (url) => {
    ...
    fs.writeFile('./allData.json', JSON.stringify(response), err => {
  if(err) {
    console.log(err);
  } else {
...
getTrial('https://api.covalenthq.com/v1/43114/address/0xC774E97f6574C302b37Eba37470F869A54946009/transactions_v2/?quote-currency=USD&format=JSON&block-signed-at-asc=false&no-logs=false&page-size=1000&key=ckey_1c56a51b5de9463fa8f4dbec5ec')